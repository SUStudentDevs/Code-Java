...
class TestGenererListeUE {
  ...
  private static ListeUE listeUE;
  @BeforeAll
  ...
  void testException() {
    ...
    assertThrows(RuntimeException.class, () -> {new ListeUE(id1, jour1, heure1, groupe1);});
    int[] id2 = new int[1]; int[] jour2 = new int[2]; int[] heure2 = new int[1]; int[] groupe2 = new int[1];
    assertThrows(RuntimeException.class, () -> {new ListeUE(id2, jour2, heure2, groupe2);});
    int[] id3 = new int[1]; int[] jour3 = new int[1]; int[] heure3 = new int[2]; int[] groupe3 = new int[1];
    assertThrows(RuntimeException.class, () -> {new ListeUE(id3, jour3, heure3, groupe3);});
    int[] id4 = new int[1]; int[] jour4 = new int[1]; int[] heure4 = new int[1]; int[] groupe4 = new int[2];
    assertThrows(RuntimeException.class, () -> {new ListeUE(id4, jour4, heure4, groupe4);});
  }
  ...
  void testGenerationLength() {
    ...
    int[] heures = {1, 1, 1, 1};
    int[] groupes = {0, 0, 0, 0};
    listeUE = new ListeUE(ids, jours, heures, groupes);
    assertEquals(4, listeUE.getListeId().size());
  }
}
